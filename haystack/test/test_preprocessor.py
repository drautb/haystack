...
class TestPreprocessor(unittest.TestCase):
    ...
    def test_it_should_rotate_by_90_and_flip_vertically_an_image_with_a_rotation_of_5(self):
        ...
        expected_calls = [call.transpose(Image.ROTATE_90), call.transpose(Image.FLIP_LEFT_RIGHT)]
        self.mock_image.assert_has_calls(expected_calls)
    ...
    def test_it_should_flip_horizontally_and_rotate_by_90_an_image_with_a_rotation_of_7(self):
        ...
        expected_calls = [call.transpose(Image.FLIP_LEFT_RIGHT), call.transpose(Image.ROTATE_90)]
        self.mock_image.assert_has_calls(expected_calls)
    ...
    def test_it_should_save_the_image_when_done(self):
        self.test_model.preprocess('/root/staging/USB/image.jpg')
